...
exports.deleteLoginKOffice = void 0;
const path_1 = __importDefault(require("path"));
const jsonConverte_1 = require("../util/jsonConverte");
const logarKOfficeController_1 = require("./logarKOfficeController");
const pathPhpSessid = path_1.default.join(__dirname, "..", "..", "cache", "phpsessid.json");
const FormData = require('form-data');
require('dotenv/config');
const deleteLoginKOffice = async (isLogar) => {
    var _a, _b;
    ...
    if (isLogar && !isError404 && res && (res === null || res === void 0 ? void 0 : res.status) == 200 && typeof (res === null || res === void 0 ? void 0 : res.data) === 'string' && ((_b = res.data) === null || _b === void 0 ? void 0 : _b.includes(`${process.env.URL_PAINELWEB_KOFFICE}/login/`))) {
        console.log('Fazendo login na plataforma web...');
        await (0, logarKOfficeController_1.logarKOfficeController)();
        return (0, exports.deleteLoginKOffice)(false);
    }
    if (!isError404 && res && (res === null || res === void 0 ? void 0 : res.status) === 200 && typeof (res === null || res === void 0 ? void 0 : res.data) === 'object') {
        const pathLoginTemp = path_1.default.join(__dirname, "..", "..", "cache", "live_temp.json");
        let logins = (0, jsonConverte_1.readJSON)(pathLoginTemp);
        for (let user of res.data['data']) {
            if (user[8].replace(/<span class="badge badge-warning">(.*?)<\/span>/, '$1') === 'Expirado') {
                ...
                console.log(`Login ${user[0]} excluido: ${res_delete === null || res_delete === void 0 ? void 0 : res_delete.data.result}`);
            }
        }
        (0, jsonConverte_1.writeJSON)(pathLoginTemp, logins);
    }
    console.log('Processo de exclusão dos logins expirados, finalizado com sucesso.');
};
exports.deleteLoginKOffice = deleteLoginKOffice;
